...
const Accordion = () => {
  ...
  const accordionItems = [
    ...
    },
    {
      ...
      content:
        "مدت زمان اخذ ویزا و مهاجرت باتوجه به شرایط هر فرد و ویزای انتخابی متفاوت است. این زمان برای هر برنامه‌ متغییربوده و ممکن است بین 3 هفته تا 2 باشد. توجه داشته باشید اعداد ذکر شده برای هربرنامه متفاوت است، حتی در شرایط یکسان برای دو فرد مجزا.",
    },
    {
